 ...
 * {@link AskCreditFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link AskCreditFragment#newInstance} factory method to
...
public class AskCreditFragment extends Fragment {
     ...
     * @return A new instance of fragment AskCreditFragment.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_ask_credit, container, false);
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onAskCreditFragmentInteraction(uri);
        }
    }
