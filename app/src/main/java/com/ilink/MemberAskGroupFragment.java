 ...
 * {@link MemberAskGroupFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link MemberAskGroupFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MemberAskGroupFragment extends Fragment implements AbsListView.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener{
    ...
    private class AcceptUser extends AsyncTask<String, String, Boolean> {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, ACCEPT_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(getActivity(), "Le membre a ete active", Toast.LENGTH_LONG).show();
                        refreshUsers();
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++)
                            try {
                                ...
                                final String member_code = sharedPreferences.getString(Config.MEMBER_CODE_SHARED_PREF, "Not Available");
                                ...
                                */
                                ...
                                if (obj.getString("code").equals(member_code) && obj.getString("Statut").equals("en cours")) {


                                    memberGroup members = new memberGroup();
                                    members.setName(String.valueOf(Html.fromHtml(obj.getString("phone"))));
                                    members.setBalance(obj.getString("Statut"));
                                    members.setAdress("Nombre de membres :"+obj.getString("nbrecode"));
