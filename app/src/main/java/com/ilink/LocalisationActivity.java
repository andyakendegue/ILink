...
public class LocalisationActivity extends AppCompatActivity implements OnMapReadyCallback, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView((int) C1558R.layout.activity_localisation);
        ...
        ((SupportMapFragment) getSupportFragmentManager().findFragmentById(C1558R.id.mapLocalisation)).getMapAsync(this);
    }

    public void onMapReady(GoogleMap googleMap) {
        this.mMap = googleMap;
        LatLng latLng = new LatLng(0.4112103d, 9.4346296d);
        this.marker = this.mMap.addMarker(new MarkerOptions().title("Vous \u00eates ici").position(latLng).icon(BitmapDescriptorFactory.fromResource(C1558R.drawable.main_marker)));
