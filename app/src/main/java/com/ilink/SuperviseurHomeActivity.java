...
public class SuperviseurHomeActivity extends AppCompatActivity
   ...
   /* @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.superviseur_home, menu);
        return true;
    }
        ...
        alertDialogBuilder.setPositiveButton("Oui",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        Intent intent = new Intent(SuperviseurHomeActivity.this, MainActivity.class);
                        startActivity(intent);
                        DatabaseHandler db= new DatabaseHandler(SuperviseurHomeActivity.this);
                        db.resetTables();
                        finish();
                    }
                });
